...
rl.on('SIGINT', function() {
  rl.question('Are you sure you want to exit?', function(answer) {
    if (answer.match(/^y(es)?$/i)) {
                ...
                classifierGnl.save('../data/classifier.json', function(err, classifier) {
...
natural.LogisticRegressionClassifier.load('../data/classifier.json', null, function(err, classifier) {
	var fromFile = true;
	if (classifier===null){
